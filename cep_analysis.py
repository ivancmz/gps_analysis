...
# Parking Kepar
center_lat = 41.64386254586618 # float(input("Enter latitude of CEP Center: "))
center_lon = -0.762850305481052 # float(input("Enter longitude of CEP Center: "))

db = pd.read_csv('tramas_export_1644257289215.csv')
